...
<script type="text/javascript" src="<?php echo base_url('views/js/imgsarv.js');?>"></script>
    ...
    <div class="content-box">
      <div class="content-box-header">
        ...
        <ul class="content-box-tabs">
          <li><a href="#tab1" class="default-tab">图集列表</a></li>
          <li><a href="#tab2">添加新图集</a></li>
        </ul>
        <div class="clear"></div>
      </div>
      <div class="content-box-content">
        ...
        <div class="tab-content" id="tab2">
          ...
          <form action="<?php site_url('imgsarv/add_imgsarv');?>" method="post">
